...
const cards: PricingCard[] = [
  ...
  },
  {
    ...
    price: 129,
    frequency: 'One-time Engagement',
    description: 'A comprehensive transformation roadmap built around your business priorities, operational goals, and AI opportunities.',
    features: [
  ...
  },
  {
    ...
    subtitle: 'Business Operations Assessment + Transformation Blueprint + Roadmap',
    price: 159,
    frequency: 'One-time Engagement',
    description: 'Everything needed to assess, plan, and transform business operations.',
    features: [
      '• Business Operations Assessment',
      '• Transformation Blueprint',
      '• Transformation Roadmap'
    ],
    cta: 'Explore Implementation Plans',
    productId: PRODUCT_IDS.FULL_STACK,
    savings: 'Most Complete Package',
    mostPopular: true,
  },
];
