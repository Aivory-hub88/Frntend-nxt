        ...
        <div style={{ zoom: 0.8 }}>
          ...
          <div className="text-center flex flex-col justify-center items-center">
            ...
            <div className="w-full max-w-[800px] mx-auto flex flex-col items-center">
              ...
              <h3 className="text-[13px] md:text-xl font-light text-white mb-12" style={{ zoom: 0.86 }}>
                No more weeks of back-and-forth consulting sessions. Just clarity, fast.
              </h3>

              <div ref={statsRef} className="flex flex-nowrap justify-center items-stretch relative flex-row w-full mt-4" style={{ zoom: 0.69 }}>
