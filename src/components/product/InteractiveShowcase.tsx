    ...
    <div className="flex-1 flex flex-col justify-center w-full opacity-0 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
      <style>{`
        @keyframes document-drop-suck {
          ...
          55% { transform: translateY(40px) scale(0); opacity: 0; }
        ...
        @keyframes receiver-scan {
          ...
          55%, 70% { border-color: rgba(174,201,157,0.8); box-shadow: 0 0 40px rgba(174,201,157,0.6), inset 0 0 20px rgba(174,201,157,0.6); transform: scaleY(0.25) scaleX(1.1); background: rgba(174,201,157,0.1); }
        ...
        <div className={`col-start-1 row-start-1 flex flex-col items-center justify-center transition-all duration-500 w-full h-full ${phase === 'blueprint' ? 'opacity-0 scale-95 pointer-events-none' : 'opacity-100 scale-100'}`}>
          ...
          {phase === 'import' && (
            <div className="flex flex-col items-center justify-start w-full pt-4">
              ...
              {/* Document falling */}
              <div className="flex flex-col items-center animate-[document-drop-suck_2.5s_ease-in-out_forwards] z-10 relative">
                 ...
                 <span className="text-sm sm:text-base text-[#aec99d] uppercase tracking-widest font-medium px-4 py-1.5 bg-[#111111] rounded-md shadow-sm">Deep Diagnostic Results</span>
              </div>
              ...
              <div className="relative w-full flex items-center justify-center z-0 h-0">
                 <div className="absolute top-[-80px] w-40 h-40 rounded-full border-2 border-white/10 animate-[receiver-scan_2.5s_ease-in-out_forwards] flex items-center justify-center pointer-events-none">
                    <div className="w-20 h-20 bg-[#aec99d] rounded-full blur-2xl opacity-0 animate-[receiver-glow_2.5s_ease-in-out_forwards]" />
                 </div>
              </div>

              {/* Engine Context */}
              <div className="flex flex-col items-center gap-4 opacity-0 animate-[fade-in-late_2.5s_ease-out_forwards] z-10 relative mt-8 w-full max-w-[420px]">
                <span className="text-xs sm:text-sm text-white/50 bg-[#111111]/80 px-4 py-1 rounded-full backdrop-blur-sm">Engine processing from deep diagnostic result</span>
          ...
          {phase === 'generate' && (
            <div className="flex flex-col items-center justify-center gap-6 animate-fade-in-up">
              ...
              <span className="text-sm sm:text-base text-[#aec99d] animate-pulse uppercase tracking-widest font-medium">Brewing Blueprint</span>
            </div>
          )}
        </div>
