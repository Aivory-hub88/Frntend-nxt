    ...
    <div className="w-full flex-1 relative overflow-hidden grid place-items-center p-4">
      <style>{`
        @keyframes document-drop-suck {
          ...
          55% { transform: translateY(30px) scale(0); opacity: 0; }
        ...
        @keyframes receiver-scan {
          ...
          55%, 70% { border-color: rgba(174,201,157,0.8); box-shadow: 0 0 20px rgba(174,201,157,0.5), inset 0 0 10px rgba(174,201,157,0.5); transform: scaleY(0.25) scaleX(1.1); background: rgba(174,201,157,0.1); }
        ...
        {phase === 'import' && (
          <div className="flex flex-col items-center justify-start w-full pt-2">
            ...
            <div className="relative w-full flex items-center justify-center z-0 h-0">
               <div className="absolute top-[-60px] w-32 h-32 rounded-full border border-white/10 animate-[receiver-scan_2.5s_ease-in-out_forwards] flex items-center justify-center pointer-events-none">
                  <div className="w-16 h-16 bg-[#aec99d] rounded-full blur-xl opacity-0 animate-[receiver-glow_2.5s_ease-in-out_forwards]" />
               </div>
            </div>

            <div className="flex flex-col items-center gap-3 opacity-0 animate-[fade-in-late_2.5s_ease-out_forwards] z-10 relative mt-6 w-full">
              <span className="text-[10px] text-white/50 bg-[#111111]/80 px-3 py-1 rounded-full backdrop-blur-sm">Engine processing from deep diagnostic result</span>
