        ...
        <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-12 mb-20">
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-start text-left">
            <p className="text-white/80 font-light leading-relaxed text-lg md:text-xl m-0 max-w-xl">
              That&rsquo;s the question that stops most AI adoption before it begins. <span className="text-white font-medium">Aivory answers it.</span>
              <br /><br />
              Assess your readiness. Get a plan built for your business. Launch it. <span className="text-white font-medium">Not a consultant. A system.</span>
              <br /><br />
